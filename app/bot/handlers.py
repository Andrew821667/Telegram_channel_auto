...
async def callback_edit_manual(callback: CallbackQuery, state: FSMContext, db: AsyncSession):
    ...
    # Показываем текущий текст для копирования и редактирования
    await callback.message.answer(
        f"<b>📝 Текущий текст поста:</b>\n\n{draft.content}\n\n"
        f"━━━━━━━━━━━━━━━━\n\n"
        f"✍️ <b>Скопируйте текст выше, отредактируйте и отправьте новую версию.</b>\n\n"
        f"Используйте HTML разметку (<b>жирный</b>, <i>курсив</i>).\n"
